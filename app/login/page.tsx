...
export default async function LoginPage({
  ...
  return (
    <div className="rounded-[28px] bg-white px-11 py-12 shadow-shell">
      ...
      <h1 className="mt-2 font-display text-[28px] font-bold text-ink">Enter password</h1>
      <p className="mt-2 text-sm text-ink-soft">This app is private — enter the password to continue.</p>

      {params.error && <p className="mt-4 text-sm font-medium text-coral-text">Wrong password. Try again.</p>}
